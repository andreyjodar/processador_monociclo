public class App {
    ...
    public static void main(String[] args) throws Exception {
        lib bib = new lib();
        instruction_memory = bib.load_binary("C:\\Users\\Andrey\\OneDrive\\Desktop\\Faculdade - Engenharia de Software\\2º Ano - Eng. Software\\Arquitetura de Computadores\\Atividades\\TesteProcessador\\src\\memory.bin");
		...
		if (decoded_instruction[0] == 0) {
			switch (decoded_instruction[1]) {
				...
				case 15:
					...
					break;
				case 16:
					store(decoded_instruction[3], registers[decoded_instruction[4]]);
					break;
    ...
    public static void add(int destiny, int operand_1, int operand_2) {
    ...
    public static void cmp_less(int destiny, int operand_1, int operand_2) {
        if (registers[operand_1] < registers[operand_2]) {
            registers[destiny] = 1;
        } else {
            registers[destiny] = 0;
    ...
    public static void cmp_greater(int destiny, int operand_1, int operand_2) {
        if (registers[operand_1] > registers[operand_2]) {
            registers[destiny] = 1;
        } else {
            registers[destiny] = 0;
    ...
    public static void cmp_less_eq(int destiny, int operand_1, int operand_2) {
        if (registers[operand_1] <= registers[operand_2]) {
            registers[destiny] = 1;
        } else {
            registers[destiny] = 0;
    ...
    public static void cmp_greater_eq(int destiny, int operand_1, int operand_2) {
        if (registers[operand_1] >= registers[operand_2]) {
            registers[destiny] = 1;
        } else {
            registers[destiny] = 0;
    ...
    public static void or(int destiny, int operand_1, int operand_2) {
    ...
    public static void xor(int destiny, int operand_1, int operand_2) {
        if(!((registers[operand_1] == 1 && registers[operand_2] == registers[operand_1]) 
    ...
    public static void store(int destiny, int register_operand_2) {
        data_memory[destiny] = register_operand_2;
    }
