public class App {
    private static short[] instructions_memory; // 16 bits por instrução (tamanho indeterminado)
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            biblioteca.load_binary("C:\\Users\\Aluno\\Desktop\\ARQ\\Monociclo\\src\\perfect-squares.bin");
